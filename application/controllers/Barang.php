...
class Barang extends CI_Controller
{
    ...
    {
        $supplier_id = encode_php_tags($id);
        $data = $this->admin->getBySupplier($supplier_id);
        output_json($data);
    }

    public function getSatuanByBarang($id)
    {
        $barang_id = encode_php_tags($id);
        $data = $this->admin->getBarangId($barang_id);
        output_json($data);
    }

    public function getBarangNolBySupplierId($id)
    {
        $supplier_id = encode_php_tags($id);
        $data = $this->admin->getBarangNolBySupplier($supplier_id);
        output_json($data);
    }
}
