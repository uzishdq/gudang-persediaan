...
<head>
    ...
    <title><?= $title; ?> | PT.KAREUMBIFARM </title>
    ...
    <!--Favicon-->
    <link rel="icon" href="<?= base_url(); ?>assets/img/KAREUMBI FARM.jpg" type="image/x-icon">
...
<body id="page-top">
        ...
        <ul class="navbar-nav bg-white sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex text-white align-items-center bg-white justify-content-center" href="">
                ...
                <div class="sidebar-brand-img">
                    <img class="" style="width: 50px;" src="assets/img/KAREUMBI FARM.jpg">
            ...
            <footer class="sticky-footer bg-light">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; PT KAREUMBI FARM </span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <script type="text/javascript">
        ...
        let datang = $('#jumlah_barang_datang');
        ...
        $(document).on('keyup', '#jumlah_ditolak', function() {
            let totalStok = parseInt(datang.val()) - parseInt(this.value);
