    ...
    <div class="col-lg-8">
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <!-- <div class="row form-group">
                    <label class="col-lg-3 text-lg-right" for="NoPO">No PO</label>
                    <div class="col-lg-5">
                        <select name="NoPO" id="NoPO" class="form-control">
                            <option value="">Pilih No PO</option>
                            <?php foreach ($list_no_po as $no_po): ?>
                                <option value="<?= $no_po['id_barang_masuk']; ?>"><?= $no_po['id_barang_masuk']; ?></option>
                            <?php endforeach; ?>
                        </select>
                        <?= form_error('NoPO', '<small class="text-danger">', '</small>'); ?>
                    </div>
                </div> -->
