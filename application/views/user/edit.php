            ...
            <div class="card-body pb-2">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="custom-control custom-radio">
                            <input <?= $user['role'] == 'kandang' ? 'checked' : ''; ?> <?= set_radio('role', 'kandang'); ?> value="kandang" type="radio" id="kandang" name="role" class="custom-control-input">
                            <label class="custom-control-label" for="kandang">Kandang</label>
                        </div>
